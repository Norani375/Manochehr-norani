...
import { 
  ...
  Award, Shield, Edit3, Plus, Trash2, RotateCcw, Sun, Moon, Contrast, Check, X, User, FileText, Network, Image as ImageIcon, Download, Eye, Activity, Users, Database, Filter, Layers, EyeOff, Menu, ChevronRight, ChevronLeft
} from 'lucide-react';
          ...
          {president && (
            <div className="flex flex-col items-center relative group">
              ...
              >
                ...
                <div className="absolute top-2.5 left-2.5 bg-blue-800/80 text-blue-200 text-[10px] px-2 py-0.5 rounded-full font-mono">
                  ID: {president.id}
                </div>
                ...
                <div className="text-[11px] text-blue-200/80">شماره پرسنلی: {president.id}</div>
              </div>
                ...
                {boardMembers.map((member) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-1">
                      <span className={`text-[10px] px-1.5 py-0.5 rounded font-mono ${theme === 'dark' ? 'bg-slate-800 text-slate-300' : 'bg-slate-100 text-slate-600'}`}>
                        ID: {member.id}
                      </span>
                    ...
                    <div className={`text-[10px] ${themeStyle.subText}`}>شماره پرسنلی: {member.id}</div>
                  </div>
                ))}
              </div>
                        ...
                        {filteredBranches.map((branch) => (
                          <div key={branch.key} className="flex flex-col items-center">
                            ...
                            >
                              ...
                              {/* Card Header with ID and Focus Button */}
