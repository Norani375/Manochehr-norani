...
const DEFAULT_LICENSE_RENEWAL_DATA: DabLicenseRenewalData = {
  ...
  branches: [
    ...
    },
    {
      ...
      repTazkiraNo: '۱۳۹۹-۱۰۰۲-۵۵۴۱۲',
      province: 'بدخشان',
      district: 'فیض‌آباد',
      nahia: 'مرکز',
      market: 'مرکزی صرافان',
      shopNo: '۱۰',
      branchNoDab: '7-0965-A5',
      phone1: '0700123456',
      phone2: '',
    },
    {
      ...
      repTazkiraNo: '۱۴۰۱-۱۵۰۲-۹۹۸۱۲',
      province: 'بلخ',
      district: 'مزارشریف',
      nahia: 'مرکز',
      market: 'سرای کفایت',
      shopNo: '۲۴',
      branchNoDab: '7-0965-A6',
      phone1: '0799887766',
      phone2: '',
    },
  ],
          ...
          <div className="flex items-center justify-between gap-4 mb-3">
            ...
            <div className="flex items-center gap-3 bg-slate-50 border border-slate-300 p-2 rounded-xl text-right">
              ...
              <div className="hidden sm:block">
                ...
                <span className="text-[10px] text-slate-600 font-bold block">لوگوی اختصاصی فورم</span>
                {onOpenLogoModal && (
                  <button
                    type="button"
                    onClick={onOpenLogoModal}
