        ...
        <div className="relative text-center mb-6 pb-4 border-b-2 border-slate-900">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4 px-2">
            ...
            <div className="hidden sm:flex flex-col items-center justify-center p-2.5 bg-slate-50 border border-slate-300 rounded-2xl text-center w-28">
              ...
              <span className="text-xs font-mono font-bold text-slate-700 mt-0.5">{formData.guarantorCompany.licenseNo}</span>
            </div>
          </div>
                  ...
                  <table className="w-full border-collapse border border-slate-900 text-xs">
                    <thead>
                      <tr className="bg-slate-200 text-slate-900 font-bold text-center text-xs">
                        <th className="border border-slate-900 py-1.5 px-2 w-[38%]">اسم و محل فعالیت تشبث</th>
                        <th className="border border-slate-900 py-1.5 px-2 w-[31%]">سکونت اصلی</th>
                        <th className="border border-slate-900 py-1.5 px-2 w-[31%]">سکونت فعلی</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
