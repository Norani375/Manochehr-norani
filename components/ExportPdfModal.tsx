...
import { Download, FileText, Check, X, ShieldCheck, Printer, Settings, Loader2 } from 'lucide-react';
...
export default function ExportPdfModal({
  ...
  defaultFilename = 'چارت_سازمانی_برکت_الله_غفوری_د_افغانستان_بانک.pdf',
}: ExportPdfModalProps) {
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden text-slate-900 dark:text-slate-100">
        ...
        <div className="bg-gradient-to-r from-blue-900 via-blue-950 to-slate-900 text-white p-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg">دانلود فایل PDF با کیفیت بالا</h3>
              <p className="text-xs text-blue-200/80">استاندارد رسمی د افغانستان بانک (DAB)</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-5">
          <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/50 rounded-2xl p-4 flex items-start gap-3">
            ...
            <div className="text-xs text-blue-900 dark:text-blue-200 leading-relaxed">
              <strong>مشخصات فایل استاندارد:</strong> چارت در قالب فایل تصویری برداری با کیفیت رزولوشن بالا همراه با سربرگ رسمی، حاشیه‌بندی دقیق و کادر مهر شرکت ذخیره می‌گردد.
            </div>
          </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={isExporting}
              className="flex items-center gap-2 bg-blue-900 hover:bg-blue-800 text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-md transition-all cursor-pointer disabled:opacity-60"
            >
              {isExporting ? (
                <>
