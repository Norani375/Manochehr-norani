...
type Field = { key: string; label: string; type?: 'text' | 'date' | 'number' | 'textarea' | 'checkbox'; required?: boolean };
...
const company: Field[] = [
  ...
  { key: 'tin', label: 'شماره تشخیصیه مالیاتی (TIN)' },
...
function declarationFields(): Field[] {
  return [
  ...
  return <main dir="rtl" className="min-h-screen bg-slate-100 p-4 md:p-8 print:bg-white print:p-0">
    <div className="mx-auto max-w-7xl">
      ...
      <div className="grid gap-5 lg:grid-cols-[310px_1fr] print:block">
        <aside className="border bg-white p-3 print:hidden"><input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="جستجوی فورم" className="mb-3 w-full border p-2" />
