...
content = content.replace("onChange={(val) => updateGuarantor(idx, 'tazkiraNo', val)}", "onChange={(val) => updateGuarantor(idx, 'tazkiraNo', val)} isTazkira")
content = content.replace("onChange={(val) => updateShareholder(idx, 'tazkiraNo', val)}", "onChange={(val) => updateShareholder(idx, 'tazkiraNo', val)} isTazkira")
